    ...
    <div class="flex gap-8">
      ...
      <div class="flex-1 min-w-0">
        ...
        <section>
          ...
          <div class="bg-surface border border-border rounded-2xl p-5 flex flex-wrap sm:flex-nowrap items-center gap-5">
            <!-- Icon -->
            ...
            <div class="flex gap-2 w-full sm:w-auto shrink-0">
              <NuxtLink
                to="/download"
                target="_blank"
                class="flex-1 sm:flex-none text-center text-xs bg-border/60 hover:bg-accent/20 hover:text-accent text-muted-light px-3 py-2 rounded-xl font-semibold transition-colors"
              >
                Preview
              </NuxtLink>
              <NuxtLink
                to="/release"
                class="flex-1 sm:flex-none text-center text-xs bg-accent hover:bg-accent-dark text-black px-3 py-2 rounded-xl font-semibold transition-colors"
              >
                Edit
              </NuxtLink>
            </div>
        ...
        <section class="mt-10">
          ...
          <div class="bg-surface border border-border rounded-2xl p-5 flex flex-wrap sm:flex-nowrap items-center gap-5">
            ...
            <NuxtLink
              to="/testers"
              class="w-full sm:w-auto text-center shrink-0 text-xs bg-accent hover:bg-accent-dark text-black px-3 py-2 rounded-xl font-semibold transition-colors"
            >
              View list
            </NuxtLink>
          </div>
